...
$("#submit-btn").click(function(e) {
    e.preventDefault();
    let caloriesGoal = document.querySelector("#caloriesGoal").value;
    let proteinLow = document.querySelector("#proteinLow").value;
    let proteinHigh = document.querySelector("#proteinHigh").value;
    let carbLow = document.querySelector("#carbLow").value;
    let carbHigh = document.querySelector("#carbHigh").value;
    let fatLow = document.querySelector("#fatLow").value;
    let fatHigh = document.querySelector("#fatHigh").value;

    //POPULATE MACRO GOALS
    let goalHTML = ('<h5>test</h5>')
    document.querySelector("#macroGoals").innerHTML = goalHTML;
});
